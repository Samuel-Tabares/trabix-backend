...
export class UsuariosController {
  ...
  async crear(@Body() createDto: CreateUsuarioDto, @CurrentUser() admin: AuthenticatedUser) {
    const result = await this.commandBus.execute(new CrearUsuarioCommand(createDto, admin.id));
  ...
  async listar(@Query() queryDto: QueryUsuariosDto): Promise<UsuariosPaginadosDto> {
  ...
  async listarEliminados(@Query() queryDto: QueryUsuariosDto): Promise<UsuariosPaginadosDto> {
  ...
  async obtenerPerfil(@CurrentUser() user: AuthenticatedUser): Promise<UsuarioResponseDto> {
  ...
  async obtenerMiJerarquia(@CurrentUser() user: AuthenticatedUser): Promise<UsuarioJerarquiaDto> {
    return this.queryBus.execute(new ObtenerJerarquiaQuery(user.id, user.id, user.rol));
  }
  ...
  async obtener(@Param('id', ParseUUIDPipe) id: string): Promise<UsuarioResponseDto> {
  ...
  async eliminar(@Param('id', ParseUUIDPipe) id: string, @CurrentUser() admin: AuthenticatedUser) {
  ...
  async obtenerJerarquia(
    ...
    return this.queryBus.execute(new ObtenerJerarquiaQuery(id, admin.id, admin.rol));
  }
