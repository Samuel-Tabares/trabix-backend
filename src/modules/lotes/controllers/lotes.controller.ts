...
export class LotesController {
  ...
  async crear(
    ...
    const lote = await this.commandBus.execute(new CrearLoteCommand(createDto, admin.id));
  ...
  async cancelar(
    ...
    return this.commandBus.execute(new CancelarLoteCommand(id, user.id, user.rol === 'ADMIN'));
  }
